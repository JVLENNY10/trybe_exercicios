...
Durante seu curso na Trybe , seus projetos serão entregues através de pushes nos repositórios do **_GitHub_** . Para podermos simular um exercício feito, você criará um arquivo .txt com um nome de sua escolha (Exemplo: trybe-skills.txt ) e utilizará o conteúdo abaixo.
...
- Vá até o seu GitHub e [crie um repositório público](https://docs.github.com/en/get-started/quickstart/create-a-repo) , onde você irá guardar todos os exercícios que desenvolverá ao longo do curso;
    ...
    - ⚠️ Lembre-se de __não__ inicializar o repositório com um arquivo README.md , pois você já criou um nos passos anteriores! 😉
- Clique no botão __SSH__ e então copie a URL do repositório;
