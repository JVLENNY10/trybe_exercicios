...
// | Entre 40,0 e acima                        | Obesidade graus III e IV  |

const categoryIMC = (weight, height) => {
  const imc = calcIMC(weight, height);
  console.log(`Seu peso ideal é: ${imc}`);
...
console.log(categoryIMC(weight, height));
